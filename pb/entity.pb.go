...
var fileDescriptor_cf50d946d740d100 = []byte{
	...
	,
}
...
type FileTransferClient interface {
	...
	Put(ctx context.Context, in *File, opts ...grpc.CallOption) (*File, error)
...
func (c *fileTransferClient) Put(ctx context.Context, in *File, opts ...grpc.CallOption) (*File, error) {
	out := new(File)
	err := c.cc.Invoke(ctx, "/pb.FileTransfer/Put", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FileTransferServer interface {
	...
	Put(context.Context, *File) (*File, error)
...
func (*UnimplementedFileTransferServer) Put(ctx context.Context, req *File) (*File, error) {
...
func _FileTransfer_Put_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(File)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FileTransferServer).Put(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.FileTransfer/Put",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileTransferServer).Put(ctx, req.(*File))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _FileTransfer_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Put",
			Handler:    _FileTransfer_Put_Handler,
		},
		{
			MethodName: "GetMisc",
